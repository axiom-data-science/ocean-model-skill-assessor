...
parser.add_argument("--catalog_type", help="Which type of catalog to make? Options include erddap, axds, local.")
# parser.add_argument("--axds_type", default="platform2")
# parser.add_argument("--kwargs")

# parser = argparse.ArgumentParser()
parser.add_argument('-k', '--kwargs', nargs='*', action=ParseKwargs, default={}, help="Format for list items is e.g. standard_names='[sea_water_practical_salinity,sea_water_temperature]'. For a description, input within quotes.")
...
if args.action == "make_catalog":
    # import pdb; pdb.set_trace()
    omsa.make_catalog(catalog_type=args.catalog_type,
